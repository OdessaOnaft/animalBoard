angular.module("animalBoard")
  ...
  .controller("homeController", ($formatter, $scope, $rootScope, $state, $translate,  $window,  $server, $timeout)=>{
...
//map configure/////////////////////////////////////////////////
  .controller("mapController", ($formatter, $scope, $rootScope, $state, $translate,  $window,  $server, $timeout)=>{
    $scope.data = []
    $scope.obj = {}
    $scope.markers = []
    $window.s = $scope
